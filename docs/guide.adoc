...
. Download the latest available zip from https://github.com/jss367/Airlock/releases[releases page]
. Unpack zip
...
* Wrong window may receive focus in multi-monitor setup: https://github.com/jss367/Airlock/issues/101[#101] (Bug in Apple API)
* Wrong borderless Alacritty window may receive focus in *single monitor* setup: https://github.com/jss367/Airlock/issues/247[#247] (Bug in Apple API)
* Performance issues: https://github.com/jss367/Airlock/issues/333[#333]
* macOS randomly switches focus back: https://github.com/jss367/Airlock/issues/289[#289]
