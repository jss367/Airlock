...
Airlock is in early development and currently has no published releases. Build it from a checkout of https://github.com/jss367/Airlock[the repository] using Xcode with Swift 6.2 or later:
